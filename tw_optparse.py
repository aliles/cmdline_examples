...
def parse_commandline(args=None):
    ...
    parser = OptionParser()
    parser.add_option("--api-key", default=os.environ.get('API_KEY', None))
    parser.add_option("--api-secret", default=os.environ.get('API_SECRET', None))
    parser.add_option("--access-token", default=os.environ.get('ACCESS_TOKEN', None))
